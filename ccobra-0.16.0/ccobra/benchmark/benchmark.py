...
class ModelInfo():
    ...
    def __init__(self, model_info, base_path, load_specific_class=None, params = ''):
...
def load_benchmark(benchmark_file, addParams = []):
    ...
    benchmark['models'] = [ModelInfo(x, base_path, params=addParams) for x in benchmark['models']]
    benchmark['params'] = addParams
