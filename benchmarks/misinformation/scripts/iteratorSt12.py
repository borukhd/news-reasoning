...
donekeys = []
trialspec = []
output = open('/home/hippo/git/news-reasoning/benchmarks/misinformation/data/Study12dataReshaped.csv', "w+")
with open('/home/hippo/git/news-reasoning/benchmarks/misinformation/data/study1/st2.csv') as lines:
    headlineKeys = ''
    line1 = True
    line2 = True
    for line in lines:
        ...
        if line1:
            ...
            for key in doubleKeys:
                ...
                if float(perHeadline[newsItem]['Partisanship_All_Combined'])>3.8:
                    ...
                    specout += ',0,0,1'
                trialList = ['Fake'+str(i) for i in range(1,17)] + ['Real'+str(i) for i in range(1,19)]
